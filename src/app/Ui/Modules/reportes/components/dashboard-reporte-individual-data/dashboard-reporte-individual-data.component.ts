...
import { DesignPageTablaDatosComponent } from '../design-reporte/design-page/design-page-tabla-datos/design-page-tabla-datos.component';
...
@Component({
  selector: 'app-dashboard-reporte-individual-data',
  standalone: true,
  imports: [
    ...
    DashboardReporteIndividualComponent
  ],
  templateUrl: './dashboard-reporte-individual-data.component.html',
  styleUrl: './dashboard-reporte-individual-data.component.css'
})
export class DashboardReporteIndividualDataComponent {
